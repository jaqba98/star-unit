...
class CommandBuilder {
    build() {
        ...
        this.#getDomainCommands().forEach((domainCommand) => this.#createCommand(program, domainCommand));
        program.parse();
    }
    ...
    #createCommand(program, domainCommand) {
        ...
        this.#getOptions(domainCommand).forEach((option) => this.#createOption(command, option));
